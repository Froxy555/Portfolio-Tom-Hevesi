        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <br />
              <br />
              Later, I signed up for a course teaching <b className="purple">C++</b>, of which I am still a member, and we deal with competitive programming on a weekly basis
